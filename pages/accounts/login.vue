  ...
  <div>
    <section class="login-area pt-80px pb-80px position-relative">
      ...
      <div class="container">
            ...
            <div class="col-lg-5 mx-auto">
              <div class="form-action-wrapper py-5">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="email" class="form-control form--control" v-model="user.username" placeholder="Email address">
                </div><!-- end form-group -->
                <div class="form-group">
                  <label class="fs-14 text-black fw-medium lh-18">Password</label>
                  <div class="input-group">
                    <input class="form-control form--control password-field" type="password" v-model="user.password" name="password" placeholder="Password">
                ...
                <div class="form-group d-flex align-items-center justify-content-between">
                  ...
                  <NuxtLink :to="{name: 'accounts-reset_password'}"><a href="recover-password.html" class="btn-text fs-14 hover-underline fw-regular">Forgot Password?</a></NuxtLink>
                </div><!-- end form-group -->
                <div class="form-group">
        ...
        <p class="text-black text-center fs-15">Don't have an account?<NuxtLink :to="{name: 'accounts-signup'}"> <a href="signup.html" class="text-color hover-underline">Sign up</a></NuxtLink></p>
      </div><!-- end container -->
    </section>
  </div>
</template>
