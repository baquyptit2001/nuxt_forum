<template>
  <section class="recovery-area pt-200px pb-80px position-relative">
    <div class="container">
      <form method="post" class="card card-item login-form" @submit.prevent="loginWithPhone">
        <div class="card-body row p-0">
          ...
          <div class="col-lg-5 mx-auto">
            <div class="form-action-wrapper py-5">
              ...
              <div class="form-group">
                <label class="fs-14 text-black fw-medium lh-18">Token</label>
                <input type="text" name="text" class="form-control form--control" placeholder="Phone number"
                       v-model="token">
              </div><!-- end form-group -->
              <div class="form-group">
...
export default {
  ...
  methods: {
    loginWithPhone() {
      axios.post(api_domain + 'accounts/login-with-token', {
        token: this.token
      })
        .then(response => {
