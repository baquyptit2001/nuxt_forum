<template>
  <section class="recovery-area pt-200px pb-80px position-relative">
    <div class="container">
      <form class="card card-item login-form" method="post" @submit.prevent="sendResetEmail">
          ...
          <div class="col-lg-5 mx-auto">
            <div class="form-action-wrapper py-5">
              ...
              <div class="form-group">
                ...
                <input v-model="email" class="form-control form--control" name="email" placeholder="Email address"
                       type="text">
              </div><!-- end form-group -->
              <div class="form-group">
