<template>
  <section class="sign-up-area pt-80px pb-80px position-relative">
    <div class="container">
      <form action="" method="post" class="card card-item" v-on:submit.prevent="signUp">
          ...
          <div class="col-lg-5 mx-auto">
            <div class="form-action-wrapper py-5">
              ...
              <div class="form-group">
                ...
                <input type="text" name="email" class="form-control form--control" placeholder="Enter name"
              ...
              <p class="fs-13 lh-18 pb-3">By clicking “Sign up”, you agree to our <a href="terms-and-conditions.html"
                ...
                of conditions</a>, <a href="privacy-policy.html" class="text-color hover-underline">privacy policy</a>
              </p>
      ...
      <p class="text-black text-center fs-15">Already have an account?
        <NuxtLink :to="{ name: 'accounts-login' }"><a href="login.html"
                                                      class="text-color hover-underline">Log in</a></NuxtLink>
      </p>
    </div><!-- end container -->
