              ...
              <div class="tab-pane fade show active" id="edit-profile" role="tabpanel" aria-labelledby="edit-profile-tab">
                <div class="user-panel-main-bar">
                  <div class="user-panel">
                    ...
                    <form method="post" class="pt-35px" @submit.prevent="updateUser">
                        ...
                        <div class="row pt-4 align-items-center">
                          <div class="col-lg-6">
                            <div class="edit-profile-photo d-flex flex-wrap align-items-center">
                              <img :src="user.avatar" alt="user avatar" id="preview" class="profile-img mr-4">
                              <div>
                                <div class="file-upload-wrap file--upload-wrap">
                                  <input type="file" id="avatar_image" name="files" class="file-upload-input" @change="uploadImage($event)" accept="image/jpeg">
                          ...
                          <div class="col-lg-6">
                            <div class="input-box">
                              ...
                              <div class="form-group">
                                <input class="form-control form--control" type="text" name="text" value="Arden Smith" v-model="user.name">
                              </div>
                            </div>
                          </div><!-- end col-lg-6 -->
                          <div class="col-lg-12">
                    ...
                    <div class="delete-account-info card card-item border border-danger">
                      <div class="card-body">
                        ...
                        <ul class="generic-list-item generic-list-item-bullet fs-15">
                          ...
                          <li>Your questions and answers will remain on the site, but will be disassociated and anonymized (the author will be listed as "user15319675") and will not indicate your authorship even if you later
                            return to the site.
                          </li>
                        </ul>
                        ...
                        <div class="custom-control custom-checkbox fs-15 mb-4">
                          ...
                          <label class="custom-control-label custom--control-label lh-22" for="delete-terms">I have read the information stated above and understand the implications of having my profile deleted. I wish to proceed
